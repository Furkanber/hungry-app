...
public final class FragmentOnBoarding2Binding implements ViewBinding {
  ...
  @NonNull
  public final LottieAnimationView animationOnboarding2;
  ...
  private FragmentOnBoarding2Binding(@NonNull ConstraintLayout rootView,
      @NonNull LottieAnimationView animationOnboarding2, @NonNull TextView textViewDescription,
      @NonNull TextView textViewTitle) {
    this.rootView = rootView;
    this.animationOnboarding2 = animationOnboarding2;
  ...
  public static FragmentOnBoarding2Binding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.animationOnboarding2;
      LottieAnimationView animationOnboarding2 = rootView.findViewById(id);
      if (animationOnboarding2 == null) {
        break missingId;
      }
      ...
      return new FragmentOnBoarding2Binding((ConstraintLayout) rootView, animationOnboarding2,
