...
public final class FragmentOrderHistoryBinding implements ViewBinding {
  ...
  private FragmentOrderHistoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView orderListRV) {
  ...
  public static FragmentOrderHistoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.orderList_RV;
      RecyclerView orderListRV = rootView.findViewById(id);
      if (orderListRV == null) {
        break missingId;
      }

      return new FragmentOrderHistoryBinding((ConstraintLayout) rootView, orderListRV);
    }
