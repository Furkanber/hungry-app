...
public abstract class Hilt_RestaurantDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestaurantDetailFragment_GeneratedInjector) this.generatedComponent()).injectRestaurantDetailFragment(UnsafeCasts.<RestaurantDetailFragment>unsafeCast(this));
    }
  }
