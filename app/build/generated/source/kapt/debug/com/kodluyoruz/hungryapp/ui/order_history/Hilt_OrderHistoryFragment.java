...
public abstract class Hilt_OrderHistoryFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderHistoryFragment_GeneratedInjector) this.generatedComponent()).injectOrderHistoryFragment(UnsafeCasts.<OrderHistoryFragment>unsafeCast(this));
    }
  }
