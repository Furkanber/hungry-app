...
public abstract class Hilt_MainOnBoardingFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainOnBoardingFragment_GeneratedInjector) this.generatedComponent()).injectMainOnBoardingFragment(UnsafeCasts.<MainOnBoardingFragment>unsafeCast(this));
    }
  }
