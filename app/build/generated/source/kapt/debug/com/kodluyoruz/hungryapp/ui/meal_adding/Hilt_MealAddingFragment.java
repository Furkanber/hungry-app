...
public abstract class Hilt_MealAddingFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MealAddingFragment_GeneratedInjector) this.generatedComponent()).injectMealAddingFragment(UnsafeCasts.<MealAddingFragment>unsafeCast(this));
    }
  }
