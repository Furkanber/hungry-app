...
public abstract class Hilt_MealDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MealDetailFragment_GeneratedInjector) this.generatedComponent()).injectMealDetailFragment(UnsafeCasts.<MealDetailFragment>unsafeCast(this));
    }
  }
