...
public abstract class Hilt_AddRestaurantFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddRestaurantFragment_GeneratedInjector) this.generatedComponent()).injectAddRestaurantFragment(UnsafeCasts.<AddRestaurantFragment>unsafeCast(this));
    }
  }
